import pytest
from source.game_state import GameState, Action, TurnPhase
...
class TestSimulationMode:
    def test_initial_state(self):
        ...
        assert state.turn_phase.name == "PLACE_TILE"
    ...
    def test_apply_place_action(self):
        ...
        assert success
        assert game.turn_phase.name == "CHOOSE_MARKET"
    ...
    def test_full_turn_cycle(self):
        ...
        assert game.turn_phase.name == "PLACE_TILE"
    ...
    def test_game_completion(self):
        ...
        assert game.turn_phase.name == "GAME_OVER"
        assert score >= 0
    ...
    def test_action_history(self):
        ...
        assert history[0].action_type == "place_tile"
        assert history[1].action_type == "choose_market"
    ...
    def test_copy_creates_independent_game(self):
        ...
        assert game_copy.turn_phase.name == "PLACE_TILE"
...
class TestPlayMode:
    ...
    def test_invalid_hand_selection(self):
        ...
        assert not game.select_hand_tile(5)  # Invalid index
        assert game.selected_hand_tile is None
    ...
    def test_game_over_status(self):
        ...
        while game.turn_phase.name != "GAME_OVER":
            actions = game.get_legal_actions()
            if not actions:
                break
            game.apply_action(actions[0])
